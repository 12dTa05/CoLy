def crawl_baophapluat_article(link, driver, title, pubDate):
    try:
        ...
        content_tag = soup.find('div', class_='article__body cms-body')
        if content_tag:
        ...
        return {'link': link, 'error': str(e), 'source': 'baophapluat', 'crawled_at': datetime.utcnow()}