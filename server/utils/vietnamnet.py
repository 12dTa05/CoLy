def crawl_vietnamnet_article(link, driver, title, pubDate):
    try:
        ...
        content_tag = soup.find('div', class_='maincontent main-content')
        if content_tag:
        ...
        return {'link': link, 'error': str(e), 'source': 'vietnamnet', 'crawled_at': datetime.utcnow()}