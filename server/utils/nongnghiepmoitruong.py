def crawl_nongnghiepmoitruong_article(link, driver, title, pubDate):
    try:
        ...
        description_tag = soup.find('h2', class_='main-intro detail-intro')
        ...
        return {'link': link, 'error': str(e), 'source': 'nongnghiepmoitruong', 'crawled_at': datetime.utcnow()}